from Figuras import Rectangulo, Cuadrado, Circulo, Triangulo  
...
class MenuFiguras:
    ...
    def mostrar_menu(self):
        ...
        print(self.term.bold_black("1. Rectángulo"))
        print(self.term.blue("2. Cuadrado"))
        print(self.term.bold_cyan("3. Círculo"))
        print(self.term.orange("4. Triángulo"))
        print(self.term.bold_white("5. Salir"))
